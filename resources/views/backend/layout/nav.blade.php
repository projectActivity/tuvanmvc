    ...
    <nav>
        ...
        <ul>
            ...
            <li id="QLPHANHOI">
                ...
                <ul>
                    <li>
                        <a href="#" title="Danh mục phản hồi">
            ...
            <li id="QLTHANHVIEN">
                ...
                <ul>
                    <li>
                        <a href="#" title="Danh mục thành viên">
                            <span class="menu-item-parent">Danh mục thành viên</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li id="QLTHONGTINCHUNG">
                ...
                <ul>
                    <li>
                        <a href="#" title="Danh mục thông tin chung">
            ...
            <li id="TUVANONLINE">
                ...
                <ul>
                    <li>
                        <a href="#" title="Danh mục tư vấn Online">
                            <span class="menu-item-parent">Danh mục tư vấn Online</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li id="VANBANPHAPLUAT">
                ...
                <ul>
                    <li>
                        <a href="#" title="Danh mục văn bản pháp luật">
            ...
            <li id="QLDATLICHHEN">
                ...
                <ul>
                    <li>
                        <a href="#" title="Danh mục đặt lịch hẹn">
            ...
            <li id="QLNguoiDung">
                ...
                <ul>
                    <li>
                        <a href="#" title="Xem danh sách người dùng">
